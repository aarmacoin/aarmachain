...
func (pre *Prestate) Apply(vmConfig vm.Config, chainConfig *params.ChainConfig,
	...
	for i, tx := range txs {
		...
		// Receipt:
		{
			...
			receipt.ValidatorReward = tx.ValidatorReward(receipt.GasUsed)
			receipt.FoundationReward = tx.FoundationReward(receipt.GasUsed)
			receipt.SystemReward = tx.SystemReward(receipt.GasUsed)
