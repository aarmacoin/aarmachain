...
var (
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllYantraProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, false, nil, &YantraConfig{Period: 0, Epoch: 30000}}
...
func (c *ChainConfig) String() string {
	...
	case c.Yantra != nil:
		if c.TerminalTotalDifficulty == nil {
			banner += "Consensus: Yantra (proof-of-reward)\n"
		} else if !c.TerminalTotalDifficultyPassed {
			banner += "Consensus: Beacon (proof-of-stake), merging from Yantra (proof-of-reward)\n"
		} else {
			banner += "Consensus: Beacon (proof-of-stake), merged from Yantra (proof-of-reward)\n"
		}
	default:
